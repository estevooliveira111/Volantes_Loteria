...
<body>
    ...
    <div class="titulo">
        ...
        <div class="letra_titulo">
            ...
            <h1>Gerador de Volantes para <a class="link" href="http://localhost/Volantes_Loteria/login/login.php">L</a>otería</h1>

        </div>

    </div>

    <form method="POST" action="http://localhost/Volantes_Loteria/documento.php" name="calc">
    ...
    <div class="númerosfixos">
        ...
        <table border="1">
                 ...
                 <button type="submit">Fazer Jogo</button>
